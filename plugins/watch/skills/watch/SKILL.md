---
name: watch
description: Watch a video from a URL or local path by downloading it with yt-dlp, extracting auto-scaled frames with ffmpeg, and combining captions or optional Whisper transcription with visual inspection. Use when the user asks to watch, inspect, summarize, diagnose, or answer questions about a video or screen recording.
license: MIT
---
